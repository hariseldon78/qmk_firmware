...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_TRANSPARENT,                                 KC_QUOTE,       KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_MINUS,       KC_RSHIFT,
    KC_LCTRL,       KC_LALT,        MO(2),          MO(2),          LT(1,KC_SPACE),                                                                                                 MO(1),          MO(2),          KC_LBRACKET,    KC_EQUAL,       KC_RBRACKET,
                                                                                                    RALT_T(KC_ENTER),KC_BSPACE,      KC_TRANSPARENT, KC_INSERT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_LGUI,        TT(1),          MO(3),          KC_TRANSPARENT, KC_DELETE,      KC_SPACE
  ),
