...
#define CLN_MCR LT(5, KC_COLN)
#define SPC_SYM LT(1, KC_SPC)
#define SCLN_ARR LT(2, KC_SCLN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(
        ...
        _______, KC_PIPE, KC_LBRC, KC_RBRC, KC_ASTR, KC_GRV, /*-------------------------------*/ KC_UNDS, KC_EXLM, KC_LT, KC_GT, KC_BSLS, _______,
    ...
    [2] = LAYOUT_split_3x6_3(
        ...
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /*---------------------------------------*/ KC_PSCR, KC_HOME, XXXXXXX, KC_END, XXXXXXX, _______,
    ...
    [3] = LAYOUT_split_3x6_3(
        ...
        _______, KC_F11, LCTL_T(KC_F12), KC_LALT, KC_LSFT, XXXXXXX, XXXXXXX, KC_RSFT, KC_LALT, KC_LCTL, XXXXXXX,
    ...
    [4] = LAYOUT_split_3x6_3(
        ...
        LCTL(KC_TAB), RCS(KC_TAB), KC_BTN2, KC_MS_U, KC_BTN1, KC_WH_U, /*-------------*/ XXXXXXX, XXXXXXX, KC_UP, XXXXXXX, KC_PGUP, _______,

        _______, KC_BTN4, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, /*----------------------*/ XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,

        _______, KC_BTN5, KC_LEFT, KC_BTN3, KC_RGHT, LCTL(KC_W), /*-------------------*/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    ...
    [5] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX, XXXXXXX, IN_PAREN, IN_PAREN, IN_QODOU, IN_QOSIN, /*------------------*/ XXXXXXX, MO(7), IN_CURLY, IN_CURLY, XXXXXXX, NL_INDNT,

        XXXXXXX, XXXXXXX, IN_BRACK, IN_BRACK, XXXXXXX, IN_QOREV, /*------------------*/ XXXXXXX, XXXXXXX, IN_ANGLE, IN_ANGLE, XXXXXXX, XXXXXXX,

        XXXXXXX, TG(6), ARROW_FU, XXXXXXX, XXXXXXX, XXXXXXX),

    [6] = LAYOUT_split_3x6_3(_______, XXXXXXX, XXXXXXX, KC_W, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_W, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, KC_A, KC_S, KC_D, XXXXXXX, XXXXXXX, KC_A, KC_S, KC_D, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, _______, XXXXXXX),
    [7] = LAYOUT_split_3x6_3(XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, IN_QODOU, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX),
    [8] = LAYOUT_split_3x6_3(_______, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______)};
